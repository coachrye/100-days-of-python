...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.button_false = Button(image=image_false, highlightthickness=0, command=self.send_false)
        self.button_true = Button(image=image_true, highlightthickness=0, command=self.send_true)
